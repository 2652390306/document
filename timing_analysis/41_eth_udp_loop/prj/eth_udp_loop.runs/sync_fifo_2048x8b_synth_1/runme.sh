...
HD_PWD='C:/Users/Admin/Desktop/wang/7020/28_eth_udp_loop/prj/eth_udp_loop.runs/sync_fifo_2048x8b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_fifo_2048x8b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_fifo_2048x8b.tcl
